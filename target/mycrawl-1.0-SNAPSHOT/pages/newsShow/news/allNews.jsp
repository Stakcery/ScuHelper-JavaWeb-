...
<%@ page import="com.Stackery.utils.newsCrawl.*" %>
        ...
        <div class="main-box">
            ...
            <div class="box-body">
                <div class="news-list">
                    <ul>
                        <%
                            crawlCyberspaceSecurityNews crawlCyberspaceSecurityNews = new crawlCyberspaceSecurityNews();
                            crawlCyberspaceSecurityNews.crawlNews();
                            crawlScientificResearchNews crawlScientificResearchNews = new crawlScientificResearchNews();
                            crawlScientificResearchNews.crawlNews();
                            crawlSecurityDepartmentNews crawlSecurityDepartmentNews = new crawlSecurityDepartmentNews();
                            crawlSecurityDepartmentNews.crawlNews();
                            crawlStudentWorkDepartmentNews crawlStudentWorkDepartmentNews = new crawlStudentWorkDepartmentNews();
                            ...
                            List<String> dataCrawl = crawlCyberspaceSecurityNews.getDataCrawl();
                            List<String> urlCrawl = crawlCyberspaceSecurityNews.getUrlCrawl();
                            List<String> titleCrawl = crawlCyberspaceSecurityNews.getTitleCrawl();
                            ...
                            dataCrawl = crawlScientificResearchNews.getDataCrawl();
                            urlCrawl = crawlScientificResearchNews.getUrlCrawl();
                            titleCrawl = crawlScientificResearchNews.getTitleCrawl();
                            for (int i = 0; i < dataCrawl.size(); i++) {
                                out.print("<li>"+"<a href=\""+urlCrawl.get(i)+"\" title=\""+titleCrawl.get(i)+"\">"+"<span class=\"date\">"+dataCrawl.get(i)+"</span>"+titleCrawl.get(i)+"</a></li>");
                            }
                            dataCrawl = crawlStudentWorkDepartmentNews.getDataCrawl();
                            urlCrawl = crawlStudentWorkDepartmentNews.getUrlCrawl();
                            titleCrawl = crawlStudentWorkDepartmentNews.getTitleCrawl();
                            for (int i = 0; i < dataCrawl.size(); i++) {
                                out.print("<li>"+"<a href=\""+urlCrawl.get(i)+"\" title=\""+titleCrawl.get(i)+"\">"+"<span class=\"date\">"+dataCrawl.get(i)+"</span>"+titleCrawl.get(i)+"</a></li>");
                            }
                            dataCrawl = crawlTeachingResearchDepartmentNews.getDataCrawl();
                            urlCrawl = crawlTeachingResearchDepartmentNews.getUrlCrawl();
                            titleCrawl = crawlTeachingResearchDepartmentNews.getTitleCrawl();
                            for (int i = 0; i < dataCrawl.size(); i++) {
                                out.print("<li>"+"<a href=\""+urlCrawl.get(i)+"\" title=\""+titleCrawl.get(i)+"\">"+"<span class=\"date\">"+dataCrawl.get(i)+"</span>"+titleCrawl.get(i)+"</a></li>");
                            }
                            dataCrawl = crawlSecurityDepartmentNews.getDataCrawl();
                            urlCrawl = crawlSecurityDepartmentNews.getUrlCrawl();
                            titleCrawl = crawlSecurityDepartmentNews.getTitleCrawl();
                            for (int i = 0; i < dataCrawl.size(); i++) {
                                out.print("<li>"+"<a href=\""+urlCrawl.get(i)+"\" title=\""+titleCrawl.get(i)+"\">"+"<span class=\"date\">"+dataCrawl.get(i)+"</span>"+titleCrawl.get(i)+"</a></li>");
                            }
                        %>
