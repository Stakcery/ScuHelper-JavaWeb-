<%@ page import="com.Stackery.utils.newsCrawl.crawlScientificResearchNews" %>
    ...
    <div class="news-list">
        <ul>
            <%
                ...
                List<String> dataCrawl = crawlScientificResearchNews.getDataCrawl();
                List<String> urlCrawl = crawlScientificResearchNews.getUrlCrawl();
                List<String> titleCrawl = crawlScientificResearchNews.getTitleCrawl();
