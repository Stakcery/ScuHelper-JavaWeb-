<%@ page import="com.Stackery.utils.newsCrawl.crawlSecurityDepartmentNews" %>
    ...
    <div class="news-list">
        <ul>
            <%
                ...
                List<String> dataCrawl = crawlSecurityDepartmentNews.getDataCrawl();
                List<String> urlCrawl = crawlSecurityDepartmentNews.getUrlCrawl();
                List<String> titleCrawl = crawlSecurityDepartmentNews.getTitleCrawl();
