<%@ page import="com.Stackery.utils.newsCrawl.crawlStudentWorkDepartmentNews" %>
    ...
    <div class="news-list">
        <ul>
            <%
                ...
                List<String> dataCrawl = crawlStudentWorkDepartmentNews.getDataCrawl();
                List<String> urlCrawl = crawlStudentWorkDepartmentNews.getUrlCrawl();
                List<String> titleCrawl = crawlStudentWorkDepartmentNews.getTitleCrawl();
