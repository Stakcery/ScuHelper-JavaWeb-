...
<%@ page import="com.Stackery.service.UserService" %>
<%@ page import="com.Stackery.service.impl.UserServiceImpl" %>
<%@ page import="com.Stackery.dao.UserDao" %>
<%@ page import="com.Stackery.dao.impl.UserDaoImpl" %>
...
<head>
    ...
    <script type="text/javascript">
        function getJumpUrl() {
            window.open("${pageContext.request.contextPath}/pages/newsShow/news.jsp")//跳转路径
        }
...
<div style="text-align:center;border-width:1px;border-style:solid;border-color:rgb(2, 204, 245);background-color:#79918e6b;border-radius:20px;">
    ...
    <p>
        <img style="border-radius:50%;max-width:100px;max-height:100px;" src="http://i1.fuimg.com/719045/27b5a8405ae4d796.jpg"></p>
    <h1 style="color:#fff;"><strong><%=(name==null?"Full Stack":"欢迎您："+name)%></strong>
    </h1>
    <p style="font-size:3vh;color:#fff;">基于爬虫技术的SCU多功能小助手</p>
    <p style="line-height:3;">
        <a style="border-radius:10px;padding:7px 30px;color:#fff;border-style:solid;text-decoration:none;" onclick="getJumpUrl()">学校新闻</a>
        ...
        <a style="border-radius:10px;padding:7px 30px;color:#fff;border-style:solid;text-decoration:none;" href="${pageContext.request.contextPath}/pages/gradesShow/grades.jsp">成绩查询</a>
        <a style="border-radius:10px;padding:7px 30px;color:#fff;border-style:solid;text-decoration:none;" href="${pageContext.request.contextPath}/pages/getCourse/getCourseTable.jsp">我的课表</a>
